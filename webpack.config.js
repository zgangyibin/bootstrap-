...
module.exports={ // commonjs规范导出模块
  ...
  plugins: [ // 插件
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/Form表单和普通按钮实现搜索跳转功能.html", // 配置打包的html文件
      filename: "Form表单和普通按钮实现搜索跳转功能.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/HTML5新标签和属性.html", // 配置打包的html文件
      filename: "HTML5新标签和属性.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/HTML表单.html", // 配置打包的html文件
      filename: "HTML表单.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/HTML路径.html", // 配置打包的html文件
      filename: "HTML路径.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/jquery简单操作.html", // 配置打包的html文件
      filename: "jquery简单操作.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/js实现tab栏切换.html", // 配置打包的html文件
      filename: "js实现tab栏切换.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/JS实现轮播.html", // 配置打包的html文件
      filename: "JS实现轮播.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/SEO优化综合内容.html", // 配置打包的html文件
      filename: "SEO优化综合内容.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
    ...
    new htmlPlugin({ // 配置打包html文件
      template: "./src/web前端开发基础环境配置.html", // 配置打包的html文件
      filename: "web前端开发基础环境配置.html", // 输出打包后的html文件
      chunks:  ["main"], // 配置html引入的js文件
      inject: "body", // 设置脚本注入的位置在body里面
      minify: {
        removeComments: true, // 去掉html的注释
